...
#Custom package
#rm -rf feeds/Boos/luci-theme-argon
#rm -rf feeds/luci/luci-theme-argon-mod
#git clone -b 18.06 https://github.com/jerrykuku/luci-theme-argon package/luci-theme-argon
#git clone https://github.com/jerrykuku/luci-app-argon-config.git package/luci-app-argon-config

#Config OpenClash
sed -i 's/ipset add localnetwork 192.168.0.0\/16/ipset add localnetwork 192.168.60.0\/24/g' feeds/Boos/luci-app-openclash/root/etc/init.d/openclash
sed -i 's/192.168.0.0\/16/192.168.60.0\/24/g' feeds/Boos/luci-app-openclash/root/etc/openclash/custom/openclash_custom_localnetwork_ipv4.list
